...
assets/
  ...
  share.png         Vorschaubild beim Teilen (WhatsApp, LinkedIn)
...
An vier Stellen steht als Adresse `https://www.kairos-origin.com/` als
Platzhalter. Sobald die echte Domain feststeht, dort ersetzen:

- `index.html` — bei `og:url`, `og:image` und `canonical` im Kopfbereich
